...
class amazonGPU(scrapy.Spider):
    ...
    def start_requests(self):
        start_urls = [
            "https://www.amazon.com/s?k=gpu+graphics+card&crid=1PA9UCVLG562C&sprefix=gpu%2Caps%2C131&ref=nb_sb_ss_deep-retrain-ln-ops-acceptance_1_3"
        ]
    ...
    def parse(self, response):
        ...
        products = response.xpath('//div[@class = "a-section"]')
